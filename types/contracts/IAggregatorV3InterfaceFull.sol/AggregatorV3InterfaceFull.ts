...
export interface AggregatorV3InterfaceFullInterface extends utils.Interface {
  functions: {
...
export interface AggregatorV3InterfaceFull extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AggregatorV3InterfaceFullInterface;
